# @eileen0817/vue-cli-auto-router-plugin
...
- **安装**
  ...
  ```
  vue add @eileen0817/create-router
  or
  npm install @eileen0817/vue-cli-auto-router-plugin -D
  or
  cnpm install @eileen0817/vue-cli-auto-router-plugin -D
  ```
